...
class UserExamPage extends BasePage {
  const UserExamPage({Key? key}) : super(key: key, title: 'Exam');

  @override
  State<StatefulWidget> createState() {
    return _UserExamPageState();
  }
}
            ...
            child: ListView.builder(
                ...
                itemBuilder: (context, index) {
                  return UserExamItem(exam: state.dataExam[index].exam, itemClick: (){
                    Navigator.of(context).pushNamed(detailExamRoute, arguments: state.dataExam[index]);
                  });
                }));
      } else {
        return Container();
